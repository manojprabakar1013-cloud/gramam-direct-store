const products = [
  {id:1,name:'Cold-Pressed Groundnut Oil',category:'Oils',price:320,unit:'1 Litre',badge:'Available',image:'assets/images/groundnut-oil.svg',description:'Traditional wooden cold-pressed groundnut oil.',features:['Wooden cold-pressed','Traditional village method','1 litre pack','Available now']},
  {id:2,name:'Jackfruit',category:'Fruits',price:50,unit:'1 kg',badge:'Farm fresh',image:'assets/images/jackfruit.svg',description:'Fresh, honey-sweet jackfruit sourced directly from village orchards. 100% naturally grown, intensely aromatic, and packed with nutrition.',features:['Naturally grown','Village orchard sourced','Sweet and aromatic','Available now']},
  {id:3,name:'Watermelon',category:'Fruits',price:30,unit:'1 kg',badge:'Hydrating',image:'assets/images/watermelon.svg',description:'Crisp, sweet, and incredibly hydrating. Sourced fresh from village fields, our naturally grown watermelons are perfect to beat the heat and stay refreshed.',features:['Fresh from village fields','Naturally grown','Sweet and juicy','Available now']},
  {id:4,name:'Amla (Nellikai)',category:'Fruits',price:80,unit:'1 kg',badge:'Vitamin C',image:'assets/images/amla.svg',description:'Traditional village-grown Indian gooseberries. Loaded with Vitamin C and natural immunity boosters, these sour-tangy amlas are perfect for daily health, juices, or pickles.',features:['Village grown','Rich in Vitamin C','Perfect for juice and pickles','Available now']},
  {id:5,name:'Banana (Vazha Pazham)',category:'Fruits',price:60,unit:'1 Dozen (12 Pieces)',badge:'Naturally ripened',image:'assets/images/banana.svg',description:'Naturally ripened, premium local village bananas. Sweet, soft, and packed with instant energy and essential nutrients for your everyday health.',features:['Naturally ripened','Local village variety','Sweet and soft','Available now']},
  {id:6,name:'Drumstick (Murungakai)',category:'Vegetables',price:70,unit:'1 kg',badge:'Fresh harvest',image:'assets/images/drumstick.svg',description:'Fresh, tender, and highly aromatic village drumsticks. Rich in iron and vitamins, perfect for adding authentic flavour to traditional sambar and aviyal.',features:['Fresh and tender','Rich in iron and vitamins','Ideal for sambar and aviyal','Available now']},
  {id:7,name:'Pomelo (Bablimass)',category:'Fruits',price:90,unit:'1 Piece (Approx. 1 kg)',badge:'Citrus fresh',image:'assets/images/pomelo.svg',description:'Freshly harvested citrus delight directly from rural orchards. With its unique mild sweet-tangy flavour, this juicy fruit is excellent for weight management and rich antioxidant intake.',features:['Rural orchard sourced','Sweet-tangy flavour','Rich in antioxidants','Available now']},
  {id:8,name:'Musk Melon (Kirnipazham)',category:'Fruits',price:50,unit:'1 kg',badge:'Summer favourite',image:'assets/images/muskmelon.svg',description:'Incredibly sweet and fragrant village musk melons. Naturally grown with zero artificial ripeners, making them perfect for thick summer milkshakes and fruit bowls.',features:['Zero artificial ripeners','Sweet and fragrant','Ideal for shakes and fruit bowls','Available now']}
];
...
function renderProduct(){
  ...
  root.innerHTML=`<div class="product-gallery"><img src="${p.image}" alt="${p.name}"></div><div class="product-copy"><span class="eyebrow">${p.category}</span><h1>${p.name}</h1><div class="rating">★★★★★ <span style="color:var(--muted);font-weight:600">4.8 (126 reviews)</span></div><div class="detail-price">${money(p.price)} <small style="font-size:.9rem;color:var(--muted)">/ ${p.unit}</small></div><p>${p.description}</p><ul class="detail-list">${p.features.map(f=>`<li>${f}</li>`).join('')}</ul><div class="quantity-row" style="flex-wrap:wrap"><div class="quantity"><button onclick="changeDetailQty(-1)">−</button><input id="detail-qty" value="1" inputmode="numeric"><button onclick="changeDetailQty(1)">+</button></div><button class="btn btn-primary" onclick="addToCart(${p.id},document.querySelector('#detail-qty').value)">Add to cart</button><button class="btn" style="background:#25D366;color:#fff;box-shadow:0 10px 24px rgba(37,211,102,.22)" onclick="openProductWhatsApp(${p.id})">💬 Order on WhatsApp</button></div><div class="trust-card" style="margin-top:1rem"><strong>🚚 Free delivery over ₹999</strong><p>Secure checkout • Carefully packed • Easy support</p></div></div>`;
...
function commonFooter(){return `<footer class="site-footer"><div class="container"><div class="footer-grid"><div><div class="brand" style="color:white"><span class="brand-mark">🌿</span><span>Gramam Direct</span></div><p>Village goodness, honestly sourced and thoughtfully delivered to your doorstep.</p></div><div><h4>Shop</h4><a href="shop.html">All products</a><a href="shop.html">Fresh fruits</a><a href="shop.html">Vegetables</a><a href="shop.html">Cold-pressed oils</a></div><div><h4>Company</h4><a href="about.html">Our story</a><a href="contact.html">Contact us</a><a href="dashboard.html">My account</a><a href="orders.html">My orders</a></div><div><h4>Help</h4><a href="contact.html">Shipping</a><a href="contact.html">Returns</a><a href="${whatsappUrl('Hi Gramam Direct, I would like to know more about your products.')}" target="_blank" rel="noopener">WhatsApp: ${whatsappDisplay}</a><a href="contact.html">Terms</a></div></div><div class="footer-bottom"><span>© 2026 Gramam Direct. All rights reserved.</span><span>Made with care for local producers.</span></div></div></footer>`}
